...
import org.firstinspires.ftc.teamcode.drive.opmode.TwoWheelTrackingLocalizerTwo;
...
public class SampleMecanumDriveTwo extends MecanumDrive {
    ...
    public SampleMecanumDriveTwo(HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);

        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.2, 0.2, Math.toRadians(0.2)), 0.5);
        ...
        setLocalizer(new TwoWheelTrackingLocalizerTwo(hardwareMap, this));
