...
public class MediumPoleRight extends OpMode {
    ...
    public static int ROTATE_COLLECT = 1826;
    final int ROTATE_DROP = 587;

    final int ROTATE_PAST = 600;

    double RotateArmBegin = 937;
    double RotateArmPosition = RotateArmBegin;
    double RotateArmOffset = 0;
    double RotateArmFinalPosition = 937;
    ...
    public void init() {
        ...
        odometry_strafe.setPosition(0.0);
...
/*        if (drive.getPoseEstimate().getY() >= -47){
        ...
        telemetry.addData("rotate arm target pos",(int)RotateArmFinalPosition);
            ...
            case LIFT_POLESEARCH_REVERSE: {
                if (epic) {
                    ...
                    if (distance_seen <= 10) {
                        ...
                        RotateArmFinalPosition = 900;
                        rotate_arm.setTargetPosition(900);
