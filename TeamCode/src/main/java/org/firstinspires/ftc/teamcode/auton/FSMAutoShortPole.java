...
public class FSMAutoShortPole extends OpMode {
    ...
    final int ROTATE_COLLECT = -433;
    final int ROTATE_DROP = -316;
    ...
    public void init() {
        ...
        drive.setPoseEstimate(new Pose2d(36, 67.75, Math.toRadians(270)));
        ...
        TrajectorySequence BlueOnRedGoCycle = drive.trajectorySequenceBuilder(new Pose2d(36, 67.75, Math.toRadians(270)))
