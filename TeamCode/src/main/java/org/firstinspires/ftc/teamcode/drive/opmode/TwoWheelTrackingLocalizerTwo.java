 ...
 *
 */
public class TwoWheelTrackingLocalizerTwo extends TwoTrackingWheelLocalizer {
    ...
    private SampleMecanumDriveTwo drive;

    public TwoWheelTrackingLocalizerTwo(HardwareMap hardwareMap, SampleMecanumDriveTwo drive) {
        super(Arrays.asList(
